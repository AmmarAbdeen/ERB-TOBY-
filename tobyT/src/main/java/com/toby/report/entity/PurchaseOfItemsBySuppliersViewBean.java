 ...
 * @author hhhh
 */
public class PurchaseOfItemsBySuppliersViewBean {
    ...
    /**
     * @return the groupSupplierName
     */
    public String getGroupSupplierName() {
        return groupSupplierName;
    }

    /**
     * @param groupSupplierName the groupSupplierName to set
     */
    public void setGroupSupplierName(String groupSupplierName) {
