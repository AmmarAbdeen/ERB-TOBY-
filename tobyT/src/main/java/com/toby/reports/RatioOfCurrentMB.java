 ...
 * @author hq002
 */
@Named("ratioOfCurrentMB")
@ViewScoped
public class RatioOfCurrentMB extends BaseGlAccountReportBean {
    ...
    public void load() {
        ...
        checkZeroes();
        totalRatio = totalOfCurrentAsset.divide(totalOfCurrentDeduction, 4, 4).setScale(2, BigDecimal.ROUND_UP);
    }
    ...
    public void checkZeroes() {
        if (totalOfCurrentAsset.compareTo(BigDecimal.ZERO) == 0) {
            totalOfCurrentAsset = BigDecimal.ONE;
        }
