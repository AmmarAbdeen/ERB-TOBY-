 ...
 * @author hq002
 */
@Named("ratioOfNetProfitToSalesMB")
@ViewScoped
public class RatioOfNetProfitToSalesMB extends BaseGlAccountReportBean {
    ...
    public void getTheValueOfSalesAndReturns() {
        ...
        validateValues();
        calculateNetSales();
        totalRatio = totalBalance.divide(valueOfNetSales, 4, 4).setScale(2, BigDecimal.ROUND_UP);
    }
