 ...
 * @author ahmed
 */
@Named("invDelegatorPurchaseByMainItemsGroupMB")
@ViewScoped
public class InvDelegatorPurchaseByMainItemsGroupMB extends BaseReportBean {
    ...
    public void search() {
        ...
        delegatorSalesByMainItemsGroupSearchBean.setTypeView(false);
    ...
    public HashMap prepareReport() {
        ...
        hashMap.put("reportNameText", " تقرير مندوب مشتريات حسب مجموعات الاصناف الرئيسية");
    ...
    //    hashMap.put("companyName", getUserData().getCompany().getName());
        ...
        if (delegatorSalesByMainItemsGroupSearchBean.getDelegateCodeFrom() != null) {
            hashMap.put("parameter_" + parameterNumber.toString(), userDDs.get("FROM_PURCH_DELE"));
            parameterNumber++;
        ...
        if (delegatorSalesByMainItemsGroupSearchBean.getDelegateCodeTo() != null) {
            hashMap.put("parameter_" + parameterNumber.toString(), userDDs.get("TO_PURCH_DELE"));
            parameterNumber++;
