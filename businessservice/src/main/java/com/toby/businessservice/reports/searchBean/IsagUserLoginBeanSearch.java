 ...
 * @author WIN7
 */
public class IsagUserLoginBeanSearch {
    ...
    public String getIsagUserCode() {
        return isagUserCode;
    }

    public void setIsagUserCode(String isagUserCode) {
        this.isagUserCode = isagUserCode;
    }
